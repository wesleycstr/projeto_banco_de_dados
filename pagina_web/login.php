      ...
      <div class="col-12 col-md-6 col-xl-7">
        <div class="d-flex justify-content-center text-bg-primary">
          <div class="col-12 col-xl-9">
            ...
            <h1 class="h1 mb-4">SiGEdu</h1>
            <h3 class="h3 mb-4">Sistema de Gerenciamento Educacional.</h3>
            <p class="lead mb-5">Gerencie seus alunos, disciplinas, notas e muito mais!</p>
            <img class="img-fluid rounded mb-4" loading="lazy" src="./imagens/logo-login.svg" width="1245" height="180" alt="Logo">
